...
REM Compila Kotlin
kotlinc -cp .;classes;lib;%CLASSPATH% -d classes src/kokoslan/kotlin/ast/*.kt src/kokoslan/kotlin/eval/*.kt src/kokoslan/kotlin/compiler/*.kt src/kokoslan/kotlin/exception/*.kt src/kokoslan/kotlin/primitive/*.kt
